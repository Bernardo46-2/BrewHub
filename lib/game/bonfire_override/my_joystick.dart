...
class MyJoystick extends JoystickController {
  final List<JoystickAction> actions;
  MyJoystickDirectional? _directional;

  MyJoystickDirectional? get directional => _directional;

  MyJoystick({
    this.actions = const [],
    MyJoystickDirectional? directional,
  ...
  Future updateDirectional(MyJoystickDirectional? directional) async {
