...
class MyJoystickDirectional {
  ...
  void directionalDown(int pointer, Offset localPosition) {
    ...
    updateDirectionalRect(localPosition);
  ...
  void updateDirectionalRect(Offset position) {
    if (_screenSize != null && isFixed) return;
